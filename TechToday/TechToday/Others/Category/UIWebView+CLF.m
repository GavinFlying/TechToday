...
- (UIImage *)fullWebpageScreenshot1 {
    CGRect initialFrame = self.frame;
    ...
    NSLog(@"category scrollViewFrame %@", NSStringFromCGRect(self.scrollView.frame));
    NSLog(@"category webViewFrame %@", NSStringFromCGRect(self.frame));
    NSLog(@"category contentSize %@", NSStringFromCGSize(self.scrollView.contentSize));
...
//    self.scrollView.contentSize = CGSizeMake(375, 700);
    ...
    CGSize fullpageSize = CGSizeMake(width, height + 315);
    
    self.frame = CGRectMake(0, 0, fullpageSize.width, fullpageSize.height);
//    self.scrollView.frame = CGRectMake(0, 0, fullpageSize.width, fullpageSize.height);
//    self.scrollView.contentSize = CGSizeMake(fullpageSize.width, fullpageSize.height);
//    self.scrollView.frame = CGRectMake(0, 0, fullpageSize.width, fullpageSize.height);
    
    NSLog(@"category fullpageSize %@", NSStringFromCGSize(fullpageSize));
    NSLog(@"category scrollViewFrame 2 %@", NSStringFromCGRect(self.scrollView.frame));
    NSLog(@"category webViewFrame 2 %@", NSStringFromCGRect(self.frame));
    
    UIGraphicsBeginImageContextWithOptions(fullpageSize, NO, 0.0f);
    NSLog(@"%f", fullpageSize.width);
    NSLog(@"%f", fullpageSize.height);
//    self.scrollView.layer.frame = CGRectMake(0, -155, fullpageSize.width, fullpageSize.height);
    
    CGContextRef context = UIGraphicsGetCurrentContext();
    [self.layer renderInContext:context];
    NSLog(@"%@", NSStringFromCGRect(self.scrollView.layer.frame));
